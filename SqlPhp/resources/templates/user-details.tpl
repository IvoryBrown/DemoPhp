    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-8"><?=$this->user->getId()?></div>
                <div class="col-sm-4">Name</div>
                <div class="col-sm-8"><?=$this->user->getName()?></div>
            </div>
            <div class="row">
                <h4>Advertisements</h4>
                <div class="row">

                    <?php if($this->userAdvertisements):?>
                        <?php foreach($this->userAdvertisements as $adv):?>
                            <div class="row"><?=$adv->getTitle()?></div>
                        <?php endforeach?>
                    <?php endif?>
                </div>
            </div>
