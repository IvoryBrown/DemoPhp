...
<head>
    ...
    <title>Demo - All advertisement</title>
    ...
    <table class="table table-bordered table-responsive">
        <thead>
            <tr>
                <th>#ID</th>
                <th>Title</th>
                <th>Name of avertiser</th>
            </tr>
        </thead>

        <?php if($this->advertisements): ?>

            <?php foreach ($this->advertisements as $adv): ?>
                <tr>
                    <td><a href="#"><?=$adv->getId()?></a></td>
                    <td><a href="#"><?=$adv->getTitle()?></a></td>
                    <td><a href="#"><?=$adv->getUser()->getName()?></a></td>
                <tr>
            <?php endforeach; ?>
